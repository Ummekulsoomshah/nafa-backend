...
export class QuizService {
  ...
  async updateRiskCategory(risk: string, id: number) {
    await this.userRepository.update(id, { riskCategory: risk });
    return { message: 'Risk category updated successfully', risk, id };
  }
}